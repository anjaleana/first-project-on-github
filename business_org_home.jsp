...
<html>
   ...
   <body>
   	...
   	<hr>
        ...
        <ul>
            <a href="business_org_viewprofile.jsp"><li>View Profile</li></a>
            <a href="business_org_updateprofile.jsp"><li>Update Profile</li></a>
            <a href="business_org_changepass.jsp"><li>Change Password</li></a>
            <a href="front.jsp"><li>Visit Site</li></a>
        </ul>
