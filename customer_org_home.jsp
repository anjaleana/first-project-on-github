  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
          <li>
          <center>
         <%String fname=(String)session.getAttribute("fname").toString();%>
         <br>
         <div style="position:absolute;top:11px;left:-450px;"><font face="Times And New Roman" size="4px" color="white">Welcome <%out.println(fname);%></font></div></center>
         <div style="position:absolute;top:11px;left:-300px"><font face="Times And New Roman" size="4x" color="White">My Profile</font></div>
         <div style="position:absolute;top:11px;left:-200px"><font face="Times And New Roman" size="4x" color="White">My Orders</font></div>
          </li>
          
          
        <li><div style="position:absolute;top:11px;left:-100px"><a href="front.jsp"><font face="Times And New Roman" size="4px" color="white">Sign Out</a></li>
